...
<body>
    ...
    echo '<pre>';
    print_r($_SESSION['info_customer']);
    echo '</pre>';
    ?>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-4">
            <div class="payment-info">
                <div><label class="credit-card-label">Name on card</label><input type="text" class="form-control credit-inputs" placeholder="<?php echo $_SESSION['info_customer']["fullname"] ?>"></div>
                <div class="row">
...
<script>
    $( document ).ready(function() {
        ...
        $.ajax({
            url: "https://localhost/market/cart/saveorder.php",
            type: "post",
            data:{note : note},
            dataType: "json",
