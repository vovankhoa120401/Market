...
class order
{
    ...
    public function addOrder(order $order, $orderDetails = [] )
    {
        ...
        try {
            ...
            // $order = new order($order->orderId,$order->vegetableID,$order->date,$order->total,$order->note);
            // $orderdetail = new orderdetail($orderDetail->orderId,$orderDetail->vegetableID,$orderDetail->quantity,$orderDetail->price);
